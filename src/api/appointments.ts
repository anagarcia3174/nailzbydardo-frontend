...
export const appointmentsApi = {
  list: () => api.get<AppointmentWithClient[]>("/appointments"),
  ...
  getTotal: (id: string) =>
    api.get<AppointmentTotal>(`/appointments/${id}/total`),
  addService: (id: string, data: AddServiceRequest) =>
    api.post<AppointmentService>(`/appointments/${id}/services`, data),
  removeService: (id: string, serviceId: string) =>
    api.delete<void>(`/appointments/${id}/services/${serviceId}`),
